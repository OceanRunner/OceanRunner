...
public class Browser : MonoBehaviour
{
    ...
    void DrawBrowser(int windowID)
    {
        ...
        if(WinType == WindowType.Open && GUI.Button(bottom, "Open"))
        {
            ...
            {
				GetComponent<SettingsManager> ().fileInput.text = FileToOpen;
            }
    ...
    void WalkTheTree(DirectoryInfo DI)
    {
        ...
        //Debug
        MyPath[] PathTreeTemp = new MyPath[ diArr.Length + fiArr.Length ];
    ...
    MyPath[] AddPathArrays(MyPath[] IN1, MyPath[] IN2)
    {
        MyPath[] Temp = new MyPath[IN1.Length + IN2.Length];
        IN1.CopyTo(Temp, 0);
